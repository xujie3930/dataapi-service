...
export SERVER_CLASS=com.jinninghui.datasphere.icreditstudio.dataapi.gateway.DataGatewayApplication
export PROFILE=$1
...
export SERVER_PID=$HOME/bin/icreditstudio-dataapi-gateway.pid
