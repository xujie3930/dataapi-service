...
public class ResourceCodeBean {
    ...
    public enum ResourceCode {
        ...
        RESOURCE_CODE_20000014("20000014", "业务流程名称只能包含汉字、英文字母、数字、英文格式的下划线，且长度在2-50之间"),
        RESOURCE_CODE_20000015("20000015", "请输入以英文字母或者汉字开头的名称"),
...
//        RESOURCE_CODE_20000041("20000041", "sql中的where条件只支持 id = ${id} and user_id = ${userId} 的形式！"),
        RESOURCE_CODE_20000041("20000041", "sql中不能包含“limit”"),
        ...
        RESOURCE_CODE_20000048("20000048", "请至少选择一个应用分组或应用进行删除！"),
        RESOURCE_CODE_20000049("20000049", "勾选的应用分组下包含【启用】状态的应用或勾选了【启用】中的应用，请停用后再进行删除！"),
        RESOURCE_CODE_20000050("20000050", "包含已发布的不能删除：所选中的API中包含已发布的API，请重新选择！"),
        RESOURCE_CODE_20000051("20000051", "该API已发布，请先停止发布后再进行操作！"),
        RESOURCE_CODE_20000052("20000052", "外部表暂不支持删除！"),
        RESOURCE_CODE_20000053("20000053", "该分组下包含启用状态的应用，请停用后再进行删除！"),
        RESOURCE_CODE_20000054("20000054", "API信息异常，请联系管理员！"),
        RESOURCE_CODE_20000055("20000055", "该接口暂不支持删除内部表！"),
