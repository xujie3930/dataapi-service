...
public class PackageUtil {
     ...
     * @return 类的完整名称
     */
    protected static List<String> getClassNameByFile(String filePath, List<String> className, boolean childPackage) {
        List<String> myClassName = new ArrayList<String>();
        File file = new File(filePath);
        File[] childFiles = file.listFiles();
        if(childFiles == null){
            throw new IllegalStateException("Class path must be not null");
        }
     ...
     * @return 类的完整名称
     */
    protected static List<String> getClassNameByJar(String jarPath, boolean childPackage) {
        List<String> myClassName = new ArrayList<String>();
     ...
     * @return 类的完整名称
     */
    protected static List<String> getClassNameByJars(URL[] urls, String packagePath, boolean childPackage) {
        List<String> myClassName = new ArrayList<String>();
        if (urls != null) {
