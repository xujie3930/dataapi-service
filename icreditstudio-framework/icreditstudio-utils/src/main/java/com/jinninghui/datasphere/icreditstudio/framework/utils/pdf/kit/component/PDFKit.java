package com.jinninghui.datasphere.icreditstudio.framework.utils.pdf.kit.component;

import com.jinninghui.datasphere.icreditstudio.framework.utils.pdf.kit.component.builder.HeaderFooterBuilder;
import com.jinninghui.datasphere.icreditstudio.framework.utils.pdf.kit.component.builder.PDFBuilder;
import com.jinninghui.datasphere.icreditstudio.framework.utils.pdf.kit.exception.PDFException;
import com.jinninghui.datasphere.icreditstudio.framework.utils.pdf.kit.util.FreeMarkerUtil;
...
public class PDFKit {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PDFKit.class);
...
//        String fontPath=getFontPath();
    ...
    /*public static String getFontPath() {
        String classpath=clazz.getClass().getResource("/").getPath();
     ...
     * @param templateName
     */
    public  void createPDF(String saveFilePath,Object data , String templateName){
        //pdf保存路径
        try {
            //设置输出路径
            setSaveFilePath(saveFilePath);

            exportToFile(templateName,data);
        } catch (Exception e) {
